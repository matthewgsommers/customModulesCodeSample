...
namespace Drupal\marketing_cloud_enhanced_interaction\Form;
 ...
 */
class EnhancedInteractionSettings extends ConfigFormBase {

  /**
   * {@inheritdoc}
   */
  public function getFormId() {
    return 'marketing_cloud_enhanced_interaction_settings';
  }
  ...
  protected function getEditableConfigNames() {
    return ['marketing_cloud_enhanced_interaction.settings'];
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    $config = $this->config('marketing_cloud_enhanced_interaction.settings');
